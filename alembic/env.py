...
class Settings(BaseSettings):
    DATABASE_USER: str = os.environ.get("DATABASE_USER_mert")
    DATABASE_PASSWORD: str = os.environ.get("DATABASE_PASSWORD_mert")
    DATABASE_HOST: str = os.environ.get("DATABASE_HOST_mert")
    DATABASE_PORT: Union[int, str] = os.environ.get("DATABASE_PORT_mert")
    DATABASE_NAME: str = os.environ.get("DATABASE_NAME_mert")
